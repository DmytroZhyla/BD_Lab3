...
psql_types_convert: dict[str, psql_types_convert_value] = {
	...
	f"BigIntegerField": psql_types_convert_value(int, lambda: None),
	...
	peewee.BigIntegerField: psql_types_convert_value(int, lambda: None),
}
...
psql_types_to_random: dict[str] = {
	...
	f"BigIntegerField": f"""trunc(random() * 100)::int""",
